  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Legacy custom colors (for backwards compatibility)
        'sl-primary': 'var(--sl-primary)',
        'sl-background': 'var(--sl-background)',
        'sl-surface': 'var(--sl-surface)',
        'sl-surface-elevated': 'var(--sl-surface-elevated)',
        'sl-text-primary': 'var(--sl-text-primary)',
        'sl-text-secondary': 'var(--sl-text-secondary)',
        'sl-border': 'var(--sl-border)',
        'sl-success': 'var(--sl-success)',
        'sl-error': 'var(--sl-error)',
